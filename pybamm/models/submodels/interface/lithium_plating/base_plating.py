...
class BasePlating(BaseInterface):
    ...
    **Extends:** :class:`pybamm.interface.BaseInterface`
    ...
    def _get_standard_concentration_variables(self, c_plated_Li, c_dead_Li):
        ...
        # if isinstance(self, pybamm.lithium_plating.NoPlating): changed Hamid
        #     c_scale = 1
        #     L_scale = 1
        # else:
        ...
        if isinstance(self, pybamm.lithium_plating.NoPlating):
            c_scale = 1
            L_from_concentration_scale = 1
            L_ref = 1
            #Hamid
            
        else:
            c_scale = param.c_Li_typ
            L_from_concentration_scale = (
                param.V_bar_plated_Li * c_scale / param.a_typ_plating_ref
            )
            L_ref = param.n.prim.L_plated_Li_ref_dim
        #     c_scale = param.c_Li_typ
        #     L_from_concentration_scale = (
        #         param.V_bar_plated_Li * c_scale / param.n.prim.a_typ
        #     )
        #     L_ref = param.n.prim.L_plated_Li_ref_dim
        
        c_plated_Li_av = pybamm.x_average(c_plated_Li)
        
        L_plated_Li = c_plated_Li * L_from_concentration_scale / L_ref
        L_plated_Li_av = pybamm.x_average(L_plated_Li)
        ...
        L_dead_Li = c_dead_Li * L_from_concentration_scale / L_ref
        L_dead_Li_av = pybamm.x_average(L_dead_Li)
