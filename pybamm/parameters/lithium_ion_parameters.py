...
class LithiumIonParameters(BaseParameters):
    ...
    def _set_dimensional_parameters(self):
        ...
        self.a_typ_plating_ref = pybamm.Parameter(  # Added Hamid
            "Reference negative electrode surface area to volume ratio "
            "for lithium plating [m-1]"
        )
...
class ParticleLithiumIonParameters(BaseParameters):
    ...
    def _set_dimensional_parameters(self):
        ...
        self.D_sol_dimensional = pybamm.Parameter(
            f"{pref}Outer SEI solvent diffusivity [m2.s-1]"
                ...
                #HAmid
        # self.L_plated_Li_ref_dim = (
        #     self.V_bar_plated_Li * self.c_plated_Li_0_dim / self.a_typ
        # )
                ##
    ...
    def _set_scales(self):
        ...
        self.L_plated_Li_ref_dim = (  #Hamid added
            main.V_bar_plated_Li
            * main.c_Li_typ
            / main.a_typ_plating_ref
        )
        
        # self.L_plated_Li_ref_dim = (
        #     main.V_bar_plated_Li * main.c_plated_Li_0_dim / self.a_typ
        # )
    ...
    def _set_dimensionless_parameters(self):
        ...
        #     / main.T_ref
        # )
        # in DomainLithiumIonParameters._set_dimensionless_parameters
        self.R_plated_Li = (
            main.F * self.j_scale * self.R_plated_Li_dimensional
            * self.L_plated_Li_ref_dim
            / main.R / main.T_ref
        )
